...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c("button", {
        attrs: { _i: 7 },
        on: { click: _vm.flexolinkStartRecord },
      }),
      _c("button", {
        attrs: { _i: 8 },
        on: { click: _vm.flexolinkStopRecord },
      }),
      _c("button", { attrs: { _i: 9 }, on: { click: _vm.flexolinkStopScan } }),
      _c("button", {
        attrs: { _i: 10 },
      ...
      _c(
        "uni-section",
        { attrs: { title: "扫描列表", type: "line", _i: 11 } },
        [
          _c("uni-data-select", {
            attrs: { localdata: _vm.range, _i: 12 },
            on: { change: _vm.change },
            model: {
              value: _vm._$s(12, "v-model", _vm.value),
              callback: function ($$v) {
                _vm.value = $$v
              },
              expression: "value",
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            [_vm._v(_vm._$s(15, "t0-0", _vm._s(_vm.battery)))]
          ),
          _c("br"),
        ]
      ),
      _c(
        "view",
        { staticClass: _vm._$s(17, "sc", "text-area"), attrs: { _i: 17 } },
        [
          _c("text", {
          ...
          _c(
            ...
            [_vm._v(_vm._$s(19, "t0-0", _vm._s(_vm.deviceVersion)))]
          ),
          _c("br"),
        ]
      ),
      _c(
        "view",
        { staticClass: _vm._$s(21, "sc", "text-area"), attrs: { _i: 21 } },
        [
          _c("text", {
          ...
          _c(
            ...
            [_vm._v(_vm._$s(23, "t0-0", _vm._s(_vm.rssi)))]
          ),
          _c("br"),
        ]
      ),
      _c(
        "view",
        { staticClass: _vm._$s(25, "sc", "text-area"), attrs: { _i: 25 } },
        [
          _c("text", {
          ...
          _c(
            "text",
            { staticClass: _vm._$s(27, "sc", "title"), attrs: { _i: 27 } },
            [_vm._v(_vm._$s(27, "t0-0", _vm._s(_vm.isWear)))]
          ),
          _c("br"),
        ]
      ),
      _c(
        "view",
        { staticClass: _vm._$s(29, "sc", "text-area"), attrs: { _i: 29 } },
        [
          _c("text", {
          ...
          _c(
            ...
            [_vm._v(_vm._$s(31, "t0-0", _vm._s(_vm.connectStatus)))]
          ),
          _c("br"),
        ]
      ),
      _c(
        "view",
        { staticClass: _vm._$s(33, "sc", "text-area"), attrs: { _i: 33 } },
        [
          _c("text", {
          ...
          _c(
            ...
            [_vm._v(_vm._$s(35, "t0-0", _vm._s(_vm.recordStatus)))]
          ),
          _c("br"),
        ]
      ),
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\nvar globalVar = 'abc';\nvar _default = {\n  data: function data() {\n    return {\n      title: 'Hello',\n      value: 0,\n      range: []\n    };\n  },\n  onLoad: function onLoad() {},\n  methods: {\n    flexolinkInit: function flexolinkInit() {\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      testModule.init({\n        apiKey: \"rla9ccbea81fa9\",\n        apiSecret: \"e6599d04cc09e75d3c975352f12588bc\"\n      }, function (e) {\n        if (e.code == 0) {\n          uni.showToast({\n            title: \"初始化成功\",\n            icon: 'none'\n          });\n        } else {\n          uni.showToast({\n            title: e.msg,\n            icon: 'none'\n          });\n        }\n      });\n    },\n    flexolinkScan: function flexolinkScan() {\n      var _this = this;\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      var result = testModule.scanDevice(function (e) {\n        if (e.code == 0) {\n          var name = e.data.bleName;\n          var mac = e.data.bleMac;\n          _this.range.push({\n            value: name,\n            text: name\n          });\n        }\n      });\n    },\n    flexolinkConnect: function flexolinkConnect() {\n      var _this2 = this;\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      var result = testModule.connectDevice({\n        bleName: globalVar,\n        bleMac: \"\"\n      }, function (e) {\n        if (e.code == 0) {\n          uni.showToast({\n            title: \"连接成功\",\n            icon: 'none'\n          });\n\n          //开启实时获取数据\n          testModule.setRealDataListener({\n            isFilter: true\n          }, function (e) {\n            var formatted = e.data.eegList.map(function (num) {\n              return num.toFixed(1);\n            });\n            _this2.title = JSON.stringify(formatted);\n          });\n\n          //获取设备信息\n          var deviceInfoResult = testModule.getDeviceInfo();\n          if (deviceInfoResult.code == 0) {\n            _this2.deviceVersion = deviceInfoResult.data.version;\n          }\n\n          //获取电量\n          var batteryResult = testModule.getBattery();\n          if (batteryResult.code == 0) {\n            _this2.battery = batteryResult.data.battery;\n          }\n\n          //获取信号强度\n          var rssiResult = testModule.getRssi();\n          if (rssiResult.code == 0) {\n            _this2.rssi = rssiResult.data.rssi;\n          }\n\n          //获取佩戴情况\n          var wearResult = testModule.getDeviceWearStatus();\n          if (wearResult.code == 0) {\n            if (wearResult.data.isWear) {\n              _this2.isWear = \"已佩戴\";\n            } else {\n              _this2.isWear = \"未佩戴\";\n            }\n          }\n          //获取设备连接情况\n          var connectResult = testModule.getConnectStatus();\n          if (connectResult.code == 0) {\n            if (connectResult.data.connectStatus) {\n              _this2.connectStatus = \"已连接\";\n            } else {\n              _this2.connectStatus = \"未连接\";\n            }\n          }\n        } else {\n          uni.showToast({\n            title: e.msg,\n            icon: 'none'\n          });\n        }\n      });\n    },\n    flexolinkDisconnect: function flexolinkDisconnect() {\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      testModule.closeDevice();\n    },\n    change: function change(e) {\n      globalVar = e;\n      __f__(\"log\", 'e:', e, \" at pages/index/index.vue:162\");\n    },\n    flexolinkGetDeviceInfo: function flexolinkGetDeviceInfo() {\n      globalVar = e;\n      __f__(\"log\", 'e:', e, \" at pages/index/index.vue:166\");\n    },\n    flexolinkSignalDetect: function flexolinkSignalDetect() {\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      var result = testModule.signalDetect(function (e) {\n        if (e.code == 0) {\n          uni.showToast({\n            title: \"信号强度检测通过\",\n            icon: 'none'\n          });\n        } else {\n          uni.showToast({\n            title: \"信号强度检测不通过\",\n            icon: 'none'\n          });\n        }\n      });\n    },\n    flexolinkStopScan: function flexolinkStopScan() {\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      testModule.stopScan();\n    },\n    flexolinkRelease: function flexolinkRelease() {\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      testModule.release();\n    },\n    flexolinkStartRecord: function flexolinkStartRecord() {\n      var _this3 = this;\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      testModule.startRecord({\n        edfPath: \"/sdcard/Android/data/uni.UNI024BC02/files/123.edf\",\n        //具体路径根据平台自行选择，Android一般选择应用沙箱路径\n        userName: \"张三\",\n        userBirthday: \"2000-01-01\",\n        userSex: 1\n      }, function (e) {\n        if (e.code == 0) {\n          if (e.msg == \"onStartRecord\") {\n            //记录开始\n            var edfPath = e.data.edfPath;\n            _this3.recordStatus = \"开始记录\";\n          } else if (e.msg == \"onRecording\") {\n            //每5秒回调一次，表示正在记录中，可实时更新记录时间\n            _this3.recordStatus = \"正在记录中\";\n          } else if (e.msg == \"onAutoStopRecord\") {\n            //记录自动结束\n          } else if (e.msg == \"onStopRecord\") {\n            _this3.recordStatus = \"结束记录\";\n            //记录结束\n          } else if (e.msg == \"onRecordFailure\") {\n            //记录失败, msg为记录失败原因\n            var msg = e.data.failureMsg;\n            _this3.recordStatus = \"记录失败 ： \" + msg;\n          }\n        }\n      });\n    },\n    flexolinkStopRecord: function flexolinkStopRecord() {\n      var testModule = uni.requireNativePlugin('sn-flexolink');\n      testModule.stopRecord();\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 60)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///59\n");
